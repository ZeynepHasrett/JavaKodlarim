...
public class C03_ArraydenTekrarEdenElementleriSilme {
    ...
    public static void main(String[] args) {
        ...
        // Set index kullanmaz, o sebeple kendi index'imizi olustururuz
        ...
        System.out.println("Array'in son hali : " + Arrays.toString(arr)); // Array'in son hali : [2, 3, 4, 5, 24, 2, 2, 4, 2, 4, 3, 5, 1]
        // Array'in son hali : [1, 2, 3, 4, 5]
