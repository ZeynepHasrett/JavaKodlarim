...
public class C11_CarRunner {
    ...
    public static void main(String[] args) {
        ...
        // Araba ozellikler ==> marka='Tofas', model='Sahin', renk='Beyaz', yil=2017, fiyat=10000


        C10_Car araba4 = new C10_Car("BMV","5.20",2005, 4000);
        System.out.println(araba4);
        // Araba ozellikler ==> marka='BMV', model='5.20', renk='renk atanmamis', yil=2005, fiyat=4000
