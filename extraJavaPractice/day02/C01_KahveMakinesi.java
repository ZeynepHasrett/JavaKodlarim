package extraJavaPractice.day02;
...
public class C01_KahveMakinesi {
     ...
     */
        ...
        System.out.println(boyut.substring(0,1).toUpperCase() +
                           boyut.substring(1) + " " +
                           hangiKahve.substring(0,1).toUpperCase() +
                           hangiKahve.substring(1) + " " +
                           " hazirdir. Afiyet olsun!!!");
