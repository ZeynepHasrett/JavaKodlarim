...
public class C04_Scanner_KullanicidanBilgiAlma {
    ...
    public static void main(String[] args) {
        ...
        // ANCAK Scanner class'indan olusturulan bir obje oldugunu belirten bir isim olmasi tercih edilir

        // 2.adim : Kullaniciya ne istediginizi soyleyin

        System.out.println("Lutfen bir tamsayi giriniz...");

        // 3.adim : Kullanicidan istedigimiz data'nin turune uygun
        //          next...() metodunu kullanip konsoldan degeri alin
