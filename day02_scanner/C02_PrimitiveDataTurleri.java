...
public class C02_PrimitiveDataTurleri {
    ...
    double sayi6 = 24.8;
    float sayi7 = 32.7f; // mutlaka yanına f ya da F yazmak gerekir
    float sayi8 = 45.9F;
    ...
    System.out.println(dbl1 / dbl2); // 3.333333333333333

    // UYARİ : double sayilari ussel olarak tuttugu icin
