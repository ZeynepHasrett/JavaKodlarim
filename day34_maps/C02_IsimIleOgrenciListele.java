...
public class C02_IsimIleOgrenciListele extends MapDepo {
    ...
    public static void main(String[] args) {
        ...
        // ogrenci map'inde verilen isme sahip olan ogrencileri
        ...
        */
        ...
        System.out.println("Ismi " + istenenIsım + " ogrenci listesi");

        // 2- her bir value'yu elden gecirip bilgileri kontrol etmek icin for each loop
        for (String eachValue : valueCollection){
            ...
            if (eachValueArr[0].equalsIgnoreCase(istenenIsım)){
                System.out.println(
                        eachValueArr[0] + " " +
                        eachValueArr[1] + " " +
                        eachValueArr[2] + " " +
