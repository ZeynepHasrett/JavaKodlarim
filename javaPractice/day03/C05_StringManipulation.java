...
public class C05_StringManipulation {
    ...
    public static void main(String[] args) {
         ...
         * Kredi kartı numarasını kontrol edin ve 16 haneden küçük olursa "Geçersiz kredi kartı numarası" yazdırın.
         * input : John White 1234234534561478
         * output: Ad : J*** Soyad :W**** kartNo:***********1478 (Adın ve soyadın baş harfleri büyük olmalıdır)
         */
        ...
        System.out.println("Ad : " + isim + " Soyad : " + soyisim + " kartNo : ************" + kkNo);
