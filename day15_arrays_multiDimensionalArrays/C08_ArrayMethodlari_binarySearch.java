...
public class C08_ArrayMethodlari_binarySearch {
    ...
    public static void main(String[] args) {
        ...
        // method call icin kullanilan argumentler (sayilar array'i ve 8)
        ...
        /*
            Arrays.binarySearch methodu bir array'de aranan elementin
            hangi index'te oldugunu verir

            ANCAK bu methoddan once sort methodu calistirilmalidir
         */
        ...
        System.out.println(Arrays.binarySearch(sayilar, 1000)); // -7
