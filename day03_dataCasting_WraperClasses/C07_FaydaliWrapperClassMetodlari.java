...
public class C07_FaydaliWrapperClassMetodlari {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Fiyatlarin Toplami : " + (fyt1 + fyt2)); // 36.74
        ...
        // System.out.println(fiyat1 < fiyat2); // Operator '<' cannot be applied to 'java.lang.String', 'java.lang.String'
        ...
        // short bir sayinin minimum kac degerini alabilecegini yazdirin
