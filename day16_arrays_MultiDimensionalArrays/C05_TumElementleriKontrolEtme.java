...
public class C05_TumElementleriKontrolEtme {
    ...
    public static void main(String[] args) {
        ...
        int[][] arr = {{2, 3, 71}, {3, 5}, {4}, {1, 2, 3, 6, 8}};
        ...
        System.out.println("arr array'indeki cift elementlerin toplami : " + toplam);
        ...
        System.out.println("Cift sayilarin ve tek sayilarin toplamlari arasindaki fark : " + (ciftSayilarinToplami - tekSayilarinToplami));
